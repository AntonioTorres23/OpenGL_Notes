...
Also remember that yaw and pitch are represented as theta ($\theta$) of the right triangles that are created when the axes are orthogonal to each other. They are represente
