...
To put this in more practical terms: in the case of a direct point light the radiance function $\Large{L}$ measures the light color, attenuated over its distance to $\Large{p}$ and scaled by $\Large{n \cdot \omega_i}$, but only over the single light ray  
