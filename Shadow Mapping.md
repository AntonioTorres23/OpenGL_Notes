...
Here is an example orthographic projection matrix as used in this note's demo scene. Because a projection matrix indirectly determines the range of what is visible (e.g. what is not clipped) 