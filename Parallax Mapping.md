...
In this example we can see the depth map value at the second layer $(D(2) = 0.73)$ is lower than the second layer's is lower than than the second layer's depth 
