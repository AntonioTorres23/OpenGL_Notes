...
As well as it goes left to right like what we see within your average vector format so row one position (1,1) is x so all other elements within this row are now 0 since we can't have two x values within one vector. 
