...
To overcome these disadvantages (especially blending) we often split the render into two parts: one deferred rendering part, and the other a forward rendering part specifically meant for blending or other special shader effects. 
