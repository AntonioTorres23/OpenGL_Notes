...
By itself this function is a bit useless. Rendering the same object a thousand times is of no use to use since each of the rendered objects is rendered exactly the same 